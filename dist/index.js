...
function ChunkReading({
  ...
  return /* @__PURE__ */ jsxs("div", { className, style: { ...S.root, ...style }, children: [
    ...
    /* @__PURE__ */ jsxs("div", { style: S.controls, children: [
      ...
      /* @__PURE__ */ jsxs("label", { style: { display: "flex", alignItems: "center", gap: 6, color: "#4b5563", cursor: "pointer" }, children: [
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "checkbox",
        ...
        return /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { style: isRev ? S.enShown : hideEnglish ? S.enHidden : S.enFaint, children: c.text }),
